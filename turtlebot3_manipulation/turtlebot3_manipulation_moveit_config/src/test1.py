...
group1_variable_values[0] = -0.029
group1_variable_values[1] = 0.669
group1_variable_values[2] = -0.119
group1_variable_values[3] = -0.234
group2_variable_values[0] = -0.01
group2_variable_values[1] = -0.01
group1.set_joint_value_target(group1_variable_values)
group2.set_joint_value_target(group2_variable_values)
